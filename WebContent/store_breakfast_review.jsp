...
String breakfast_type = request.getParameter("reviewed_btype");
int rating = Integer.valueOf(request.getParameter("btype_rating"));
int hotel_id = Integer.valueOf(request.getParameter("review_hotelID"));

String review_comment = request.getParameter("btype_text");
...
String new_breakfast_review = "INSERT INTO BreakReview_Evaluated values(?, ?, ?)";
PreparedStatement ps_2 = con.prepareStatement(new_breakfast_review);
ps_2.setInt(1, review_id);
ps_2.setString(2, breakfast_type);
