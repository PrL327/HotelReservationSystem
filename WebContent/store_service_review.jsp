...
String service_type = request.getParameter("service_stype");
int rating = Integer.valueOf(request.getParameter("stype_rating"));
int hotel_id = Integer.valueOf(request.getParameter("review_hotelID"));

String review_comment = request.getParameter("stype_text");
